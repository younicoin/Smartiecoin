...
* WebSocket: [https://github.com/vishcoin/insight-api-smartiecoin#web-socket-api](https://github.com/vishcoin/insight-api-smartiecoin#web-socket-api)
* API: [https://github.com/vishcoin/insight-api-smartiecoin#instantsend-transactions](https://github.com/vishcoin/insight-api-smartiecoin#instantsend-transactions)
...
By default, the Smartiecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Smartiecoin Core daemon:
