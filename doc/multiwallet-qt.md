...
Only requiring some minor changes is smartiecoin.cpp.
...
Changes to smartiecoin.cpp
----------------------
smartiecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
