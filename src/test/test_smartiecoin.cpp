...
#define BOOST_TEST_MODULE Smartiecoin Test Suite

#include "test_smartiecoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_smartiecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
