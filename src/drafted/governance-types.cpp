...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SmartiecoinNetwork") type = SmartiecoinNetwork;
    if(strType == "SmartiecoinNetworkVariable") type = SmartiecoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SmartiecoinNetwork) s = "SmartiecoinNetwork";
    if(type == SmartiecoinNetworkVariable) s = "SmartiecoinNetworkVariable";
