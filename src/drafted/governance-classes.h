 ...
 *
 *   // network
 *   CSmartiecoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.smartiecoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSmartiecoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSmartiecoinNetwork(UniValue objIn)
    {
...
// // can be under: SmartiecoinNetwork
// //   -- signature requirements : Key1(User)
// class CSmartiecoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SmartiecoinNetwork);
//     // }
